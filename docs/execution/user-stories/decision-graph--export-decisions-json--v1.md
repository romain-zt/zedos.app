# User Story: Export Decisions Json (v1)

## Parent Scope Slice

[decision-graph--export-decisions-json](../../product/scope-slices/decision-graph--export-decisions-json.md)
...
As a **signed-in founder**, I want to **include decisions.json in my Cursor export package** so that **my coding agent inherits structured decision context**.

...
**Read first:** `.cursor/core/rules/execution-loop.mdc`  
**Align with:** `.cursor/core/rules/feature-area-workflow.mdc`, `.cursor/core/commands/feature-area.md`, `.cursor/core/checkers/scope-readiness-checker.md`

# User Story: Use Template On Create (v1)

## Parent Scope Slice

[templates-marketplace--use-template-on-create](../../product/scope-slices/templates-marketplace--use-template-on-create.md)
...
As a **signed-in founder**, I want to **start a project from a template in one click** so that **my journey mode and metadata match the template intent**.

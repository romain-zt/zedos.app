...
- `docs/prd/PRD.md` from `.cursor/core/templates/prd/PRD.template.md`
- `docs/prd/state.md` from `.cursor/core/templates/prd/state.template.md`
- `docs/prd/history.md` from `.cursor/core/templates/prd/history.template.md`
- `docs/prd/questions/open-questions.md` from `.cursor/core/templates/prd/open-questions.template.md`
- `docs/product-decisions/README.md` from `.cursor/core/templates/prd/product-decisions-readme.template.md`

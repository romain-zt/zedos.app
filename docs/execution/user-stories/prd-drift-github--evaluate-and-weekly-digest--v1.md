# User Story: Evaluate And Weekly Digest (v1)

## Parent Scope Slice

[prd-drift-github--evaluate-and-weekly-digest](../../product/scope-slices/prd-drift-github--evaluate-and-weekly-digest.md)
...
As a **signed-in founder**, I want to **receive drift alerts when GitHub and my PRD disagree** so that **I notice scope creep before investors or teammates do**.

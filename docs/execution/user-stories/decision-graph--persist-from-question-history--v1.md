...
As a **signed-in founder**, I want to **see my clarification history stored as durable product decisions** so that **my PRD rationale is traceable without re-entering past turns**.

# User Story: Adversarial Review Report (v1)

## Parent Scope Slice

[ai-red-team--adversarial-review-report](../../product/scope-slices/ai-red-team--adversarial-review-report.md)
...
As a **Pro founder**, I want to **run an adversarial review before investor share** so that **I fix weak claims and missing risks before external eyes**.

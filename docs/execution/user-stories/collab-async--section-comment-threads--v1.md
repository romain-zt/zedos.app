# User Story: Section Comment Threads (v1)

## Parent Scope Slice

[collab-async--section-comment-threads](../../product/scope-slices/collab-async--section-comment-threads.md)
...
As a **project owner or commenter**, I want to **comment on PRD sections and resolve threads** so that **we align on specific sections instead of vague email threads**.

...
export const featureSplits = pgTable(
  'feature_splits',
  {
    id: text('id')
      .primaryKey()
...
export const featureSplitClusters = pgTable(
...
/** Drizzle row types (domain entity is separate in apps/web) */
export type FeatureSplitRow = typeof featureSplits.$inferSelect;
export type NewFeatureSplitRow = typeof featureSplits.$inferInsert;
export type FeatureSplitClusterRow = typeof featureSplitClusters.$inferSelect;
export type NewFeatureSplitClusterRow = typeof featureSplitClusters.$inferInsert;

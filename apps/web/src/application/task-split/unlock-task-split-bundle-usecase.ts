...
const logger = createLogger({ operation: 'UnlockTaskSplitBundleUseCase' });

export class UnlockTaskSplitBundleUseCase {
  constructor(
  ...
  async execute(
    ...
    return this.bundleRepository.unlock(projectId);
  }
}

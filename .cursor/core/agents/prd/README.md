...
- `/prd init` — initialize missing PRD docs workspace from `.cursor/core/templates/prd/`
...
- Versioning and update triggers follow [`.cursor/core/rules/10-prd-discovery.mdc`](../../rules/10-prd-discovery.mdc).
